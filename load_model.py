...
def kociemba_to_onehot(kociemba_str: str):
    """
    Función para convertir de la notación de kociemba
    al one-shot encoding
    """
    color_mapping = {
        "B": [1, 0, 0, 0, 0, 0],
        "L": [0, 1, 0, 0, 0, 0],
...
for i in range(len(patterns)):
    ...
    print(
        f"The model predicts this cube is approximately {predicted_steps_value:.2f} steps away from being solved."
    )
